            ...
            return SingleChildScrollView(
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      Container(
                        ...
                        decoration: const BoxDecoration(
                          color: Color(0xFF00C853), // Green for Customer
                          shape: BoxShape.circle,
                        ),
                        child: const Center(
                          child: Icon(Icons.person_outline_rounded, color: Colors.white, size: 40),
                        ),
                      ),
                  ...
                  // Contact Info Cards
                  _buildInfoCard(Icons.email_outlined, "Email", user?.email ?? "customer@smartsauda.com"),
                  const SizedBox(height: 16),
                  _buildInfoCard(Icons.phone_outlined, "Phone", "+92 321 6549870"),
